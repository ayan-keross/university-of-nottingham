...
public class PipelineProjectService {
    ...
    // PipelineProject existingProject =
    // pipelineProjectRepository.findByProjectIdentifier(projectIdentifier);
    // if (existingProject == null) {
    // throw new ResourceNotFoundException("Director Approval project not found: " +
    // projectIdentifier);
    // }
