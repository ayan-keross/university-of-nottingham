...
import com.ikon.uonserver.service.workflow.PipelineInflightService;
...
public class PipelineProjectController {
    ...
    @Autowired
    PipelineInflightService pipelineInflightService;
    ...
    // send directorApproval project to inflight
    // mark projectStatus inflight
    @PatchMapping("/{projectIdentifier}/send-to-inflight")
    public PipelineProject sendToInflight(@PathVariable String projectIdentifier){
        return pipelineInflightService.sendToInflight(projectIdentifier);
    }
}
